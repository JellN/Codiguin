package com.example.jelln.medispache.Adapter;
...
public class ConfirmaAdapter extends RecyclerView.Adapter<ConfirmaAdapter.ViewHolder> {

    private Context mContext;
    private List<Usuarios> mUsers;
    private boolean ischat;
    String theLastMessage;
    public ConfirmaAdapter(Context mContext, List<Usuarios> mUsers, boolean ischat){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ConfirmaAdapter.ViewHolder(view);
    }
